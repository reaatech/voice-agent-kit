---
"@reaatech/voice-agent-core": minor
"@reaatech/voice-agent-stt": minor
"@reaatech/voice-agent-tts": minor
"@reaatech/voice-agent-telephony": minor
"@reaatech/voice-agent-mcp-client": minor
---

Prepare packages for first npm publish.
