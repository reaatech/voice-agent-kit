...
This directory contains reference documentation for the voice-agent-kit project.

## Files

- **LATENCY_BUDGET.md** — Per-provider latency characteristics, budget allocation, and tuning guidance for production deployments.
