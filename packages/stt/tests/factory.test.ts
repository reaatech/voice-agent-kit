...
describe('STT Provider Factory', () => {
  it('should create a DeepgramSTTProvider', () => {
    const provider = createSTTProvider({ provider: 'deepgram', config: { provider: 'deepgram', sampleRate: 8000 } });
  ...
  it('should create an AssemblyAIProvider', () => {
    const provider = createSTTProvider({ provider: 'assemblyai', config: { provider: 'assemblyai', sampleRate: 16000 } });
  ...
  it('should create an AWSTranscribeProvider', () => {
    const provider = createSTTProvider({ provider: 'aws-transcribe', config: { provider: 'aws-transcribe', sampleRate: 8000 } });
  ...
  it('should create a GoogleCloudSTTProvider', () => {
    const provider = createSTTProvider({ provider: 'google-cloud-stt', config: { provider: 'google-cloud-stt', sampleRate: 8000 } });
  ...
  it('should create a GroqWhisperSTTProvider', () => {
    const provider = createSTTProvider({ provider: 'groq-whisper', config: { provider: 'groq-whisper', sampleRate: 16000 } });
  ...
  it('should create an OpenAIRealtimeSTTProvider', () => {
    const provider = createSTTProvider({ provider: 'openai-realtime', config: { provider: 'openai-realtime', sampleRate: 24000 } });
  ...
  it('should create an OpenAIWhisperSTTProvider', () => {
    const provider = createSTTProvider({ provider: 'openai-whisper', config: { provider: 'openai-whisper', sampleRate: 16000 } });
  ...
  it('should throw for unknown provider', () => {
    expect(() =>
      createSTTProvider({ provider: 'unknown' as never, config: { provider: 'unknown', sampleRate: 8000 } }),
